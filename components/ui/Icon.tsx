...
type IconName = 'dashboard' | 'users' | 'zap' | 'briefcase' | 'chart' | 'settings' | 'building' | 'clipboard' | 'bot' | 'creditCard' | 'search' | 'bell' | 'sun' | 'moon' | 'chevronDown' | 'logo' | 'menu' | 'close' | 'plus' | 'edit' | 'trash' | 'arrowUpRight' | 'logout';
...
const Icon: React.FC<IconProps> = ({ name, className = '', ...props }) => {
    const icons: Record<IconName, JSX.Element> = {
        ...
        building: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m-1 4h1m5-4h1m-1 4h1m-1-4h1m-1 4h1" />,
